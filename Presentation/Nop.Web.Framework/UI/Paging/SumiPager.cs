...
namespace Nop.Web.Framework.UI.Paging
{
    ...
    /// </summary>
    public partial class SumiPager : IHtmlContent
    {
        /// <summary>
        /// Model
        /// </summary>
        ...
        /// </summary>
        protected string individualPageCssClass = "single-pagination";
        /// <summary>
		...
		/// </summary>
        protected string mainUlCssClass = "site-pagination";
		...
		public SumiPager(IPageableModel model, ViewContext context)
        {
            this.model = model;
            viewContext = context;
        ...
        public SumiPager QueryParam(string value)
        {
            pageQueryName = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowTotalSummary(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowPagerItems(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowFirst(bool value)
        {
            showFirst = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowPrevious(bool value)
        {
            showPrevious = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowNext(bool value)
        {
            showNext = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowLast(bool value)
        {
            showLast = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager ShowIndividualPages(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager RenderEmptyParameters(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager IndividualPagesDisplayedCount(int value)
        {
        ...
        /// <returns>Pager</returns>
        public SumiPager BooleanParameterName(string paramName)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager FirstPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager PreviousPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager CurrentPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager IndividualPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager NextPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager LastPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public SumiPager MainUlCssClass(string value)
        {
        ...
        public virtual string GenerateHtmlString()
        {
            ...
            {
                links.Append("<a class=\"total-summary\">");
            ...
            if (showPagerItems && (model.TotalPages > 1))
            {
                ...
                if (showIndividualPages)
                {
                    ...
                    for (var i = firstIndividualPageIndex; i <= lastIndividualPageIndex; i++)
                    {
                        ...
                        {
                            links.AppendFormat("<a class=\"" + currentPageCssClass + "\"><span>{0}</span></a>", (i + 1));
                        }
                        else
                        {
            ...
            if (!string.IsNullOrEmpty(result))
            {
                ...
                result = string.Format("<div{0}>", string.IsNullOrEmpty(mainUlCssClass) ? "" : " class=\"" + mainUlCssClass + "\"") + result + "</div>";
            }
            return result;
        }
        /// <summary>
